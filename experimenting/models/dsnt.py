...
Credits: https://github.com/anibali/margipose/blob/a9dbe5c3151d7a7e071df6275d5702c07ef5152d/src/margipose/dsntnn.py#L12
"""
...
def dsnt(heatmaps, transform=None):
    ...
    mu = torch.cat([_coord_expectation(heatmaps, dim, transform=transform).unsqueeze(-1) for dim in dim_range], -1)
    return mu
